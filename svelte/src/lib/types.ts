...
export type Annotation = {
  ...
  // AFS 1.1: annotation kind — "feedback" is the default (backward-compatible)
  kind?: "feedback" | "placement" | "rearrange";

  // kind: "placement" — component placed in layout mode
  placementData?: {
  ...
  // kind: "rearrange" — section moved in layout mode
  rearrangeData?: {
    selector: string;
    label: string;
    tagName: string;
